...
MACRO(ICMAKER_DEPENDENCIES)
  ...
  FOREACH(_dependency ${__dependency})
    ...
    IF(ICMAKER_VERBOSE)
      message(STATUS "  LOOKING FOR  ${_nameUpper}_FOUND = ${${_nameUpper}_FOUND} or ${_name}_FOUND = ${${_name}_FOUND}")
    ENDIF()
    IF(${_nameUpper}_FOUND OR ${_name}_FOUND)
...
MACRO(ICMAKER_BUILD_LIBRARY)
  IF(ICMAKER_VERBOSE)
    message(STATUS "XXXX. Building LIBRARY ${icmaker_target}:")
    message(STATUS "XXXX.XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX.XXX")
  ENDIF()
